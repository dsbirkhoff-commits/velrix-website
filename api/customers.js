...
export default async function handler(req, res) {
  ...
  if (req.method === "PUT") {
    ...
    // GEEN updates.updated_at hier — de customers-tabel heeft, in
    // tegenstelling tot services, geen updated_at-kolom. Dit was de
    // 100% bevestigde oorzaak (PostgREST PGRST204: "Could not find the
    // 'updated_at' column of 'customers' in the schema cache").
